...
public class Jflame_dashboard_order extends JFrame {
    ...
    // สร้างเมนูบาร์ (ข้างบนสุด)
    private JMenuBar createMenuBar() {
        JMenuBar menuBar = new JMenuBar();
        menuBar.setBackground(new Color(230, 230, 230)); // สีเทาอ่อนสำหรับ MenuBar
        JMenu menu = new JMenu("Menu");
        JMenuItem dashboardItem = new JMenuItem("Go to Dashboard");
        // เพิ่ม Action Listener ในการเปิดหน้าต่าง Dashboard ในระบบจริง
    ...
    // สร้างส่วนค้นหาสินค้าทางซ้ายสุด
     private JPanel createProductPanel(Color panelColor, Color accentColor) {
        ...
        JButton dashboardButton = createStyledButton("Go to Dashboard", new Color(220, 53, 69), Color.WHITE);
